...
open Parsing;;
# 2 "unix2/cdk_passwd_parsers.mly"
(***********************************************************************)
(*                                                                     *)
(*                           xlib for Ocaml                            *)
(*                                                                     *)
...
(*                                                                     *)
(***********************************************************************)
# 21 "unix2/cdk_passwd_parsers.ml"
let yytransl_const = [|
    0 (* EOF *);
  257 (* EOL *);
  258 (* SEP *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 32 "unix2/cdk_passwd_parsers.mly"
                                ( _1 :: _3 )
# 152 "unix2/cdk_passwd_parsers.ml"
               : string list list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'passwd_line) in
    Obj.repr(
# 33 "unix2/cdk_passwd_parsers.mly"
                                ( [_1] )
# 159 "unix2/cdk_passwd_parsers.ml"
               : string list list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : string) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'passwd_line) in
    Obj.repr(
# 37 "unix2/cdk_passwd_parsers.mly"
                         ( _1 :: _3 )
# 167 "unix2/cdk_passwd_parsers.ml"
               : 'passwd_line))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'passwd_line) in
    Obj.repr(
# 38 "unix2/cdk_passwd_parsers.mly"
                         ( "" :: _2 )
# 174 "unix2/cdk_passwd_parsers.ml"
               : 'passwd_line))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 39 "unix2/cdk_passwd_parsers.mly"
                         ( [_1] )
# 181 "unix2/cdk_passwd_parsers.ml"
               : 'passwd_line))
; (fun __caml_parser_env ->
    Obj.repr(
# 40 "unix2/cdk_passwd_parsers.mly"
                         ( [""] )
# 187 "unix2/cdk_passwd_parsers.ml"
               : 'passwd_line))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : token list) in
    Obj.repr(
# 44 "unix2/cdk_passwd_parsers.mly"
                         ( TILDE :: _2 )
# 194 "unix2/cdk_passwd_parsers.ml"
               : token list))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : token list) in
    Obj.repr(
# 45 "unix2/cdk_passwd_parsers.mly"
                         ( SEP :: _2 )
# 201 "unix2/cdk_passwd_parsers.ml"
               : token list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : token list) in
    Obj.repr(
# 46 "unix2/cdk_passwd_parsers.mly"
                         ( (IDENT _1) :: _2 )
# 209 "unix2/cdk_passwd_parsers.ml"
               : token list))
; (fun __caml_parser_env ->
    Obj.repr(
# 47 "unix2/cdk_passwd_parsers.mly"
                         ( [] )
# 215 "unix2/cdk_passwd_parsers.ml"
               : token list))
(* Entry parse_passwd *)

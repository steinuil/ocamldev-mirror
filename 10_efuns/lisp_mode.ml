...
let __ocaml_lex_tables = {
  Lexing.lex_base = 
   "\000\000\238\255\239\255\159\000\241\255\242\255\243\255\244\255\
    ...
    \078\000\193\000\194\000\217\002\255\255\084\002\253\255\184\000\
    \209\000\183\002\252\255";
  Lexing.lex_backtrk = 
   "\015\000\255\255\255\255\015\000\255\255\255\255\255\255\255\255\
    ...
    \255\255\255\255\255\255\005\000\255\255\255\255\255\255\001\000\
  ...
  Lexing.lex_default = 
   "\017\000\000\000\000\000\255\255\000\000\000\000\000\000\000\000\
    ...
    \032\000\032\000\031\000\255\255\000\000\255\255\000\000\255\255\
  ...
  Lexing.lex_trans = 
   "\001\000\001\000\001\000\001\000\001\000\001\000\001\000\001\000\
    ...
    \001\000\001\000\001\000\001\000\001\000\001\000\001\000\001\000\
    \001\000\001\000\001\000\001\000\001\000\001\000\001\000\001\000\
    \003\000\040\000\040\000\003\000\003\000\003\000\000\000\000\000\
    ...
    \040\000\003\000\040\000\003\000\003\000\003\000\003\000\003\000\
    \000\000\000\000\000\000\000\000\036\000\000\000\003\000\000\000\
    \000\000\003\000\003\000\003\000\000\000\000\000\000\000\003\000\
    \003\000\040\000\003\000\003\000\003\000\000\000\000\000\001\000\
    ...
    \000\000\000\000\000\000\003\000\021\000\003\000\035\000\024\000\
    ...
    \000\000\255\255\014\000\000\000\000\000\025\000\025\000\025\000\
    ...
    \255\255\003\000\000\000\255\255\041\000\041\000\041\000\041\000\
    ...
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\040\000\000\000\000\000\039\000\042\000\
    \042\000\042\000\042\000\042\000\042\000\042\000\042\000\042\000\
    \042\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\255\255\038\000\000\000\000\000\000\000\000\000\
  ...
  Lexing.lex_check = 
   "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    ...
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \003\000\039\000\039\000\003\000\003\000\003\000\255\255\255\255\
    ...
    \039\000\003\000\040\000\003\000\003\000\003\000\003\000\003\000\
    ...
    \008\000\040\000\008\000\008\000\008\000\255\255\255\255\000\000\
    ...
    \018\000\018\000\255\255\018\000\037\000\037\000\037\000\037\000\
    ...
    \018\000\018\000\018\000\018\000\018\000\018\000\018\000\018\000\
    \018\000\018\000\018\000\018\000\018\000\018\000\018\000\018\000\
    \018\000\018\000\018\000\035\000\255\255\255\255\035\000\041\000\
    \041\000\041\000\041\000\041\000\041\000\041\000\041\000\041\000\
    \041\000\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\018\000\035\000\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
...
and __ocaml_lex_token_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 127 "efuns/lisp_mode.mll"
      ( token lexbuf )
# 402 "efuns/lisp_mode.ml"

  | 1 ->
# 128 "efuns/lisp_mode.mll"
           ( let (p,_) as pos = position lexbuf in pos, EOL p )
# 407 "efuns/lisp_mode.ml"

  | 2 ->
# 130 "efuns/lisp_mode.mll"
      ( position lexbuf,
      let s = Lexing.lexeme lexbuf in
      IDENT )
# 414 "efuns/lisp_mode.ml"

  | 3 ->
# 135 "efuns/lisp_mode.mll"
      ( position lexbuf, NUM )
# 419 "efuns/lisp_mode.ml"

  | 4 ->
# 137 "efuns/lisp_mode.mll"
      ( reset_string_buffer();
...
# 434 "efuns/lisp_mode.ml"

  | 5 ->
# 149 "efuns/lisp_mode.mll"
                        ( position lexbuf, COMMENT )
# 439 "efuns/lisp_mode.ml"

  | 6 ->
# 151 "efuns/lisp_mode.mll"
         ( position lexbuf, QUOTE  )
# 444 "efuns/lisp_mode.ml"

  | 7 ->
# 152 "efuns/lisp_mode.mll"
         ( position lexbuf, LPAREN  )
# 449 "efuns/lisp_mode.ml"

  | 8 ->
# 153 "efuns/lisp_mode.mll"
         ( position lexbuf, RPAREN  )
# 454 "efuns/lisp_mode.ml"

  | 9 ->
# 154 "efuns/lisp_mode.mll"
         ( position lexbuf, COMMA  )
# 459 "efuns/lisp_mode.ml"

  | 10 ->
# 155 "efuns/lisp_mode.mll"
         ( position lexbuf, DOT  )
# 464 "efuns/lisp_mode.ml"

  | 11 ->
# 156 "efuns/lisp_mode.mll"
         ( position lexbuf, LBRACKET  )
# 469 "efuns/lisp_mode.ml"

  | 12 ->
# 157 "efuns/lisp_mode.mll"
         ( position lexbuf, RBRACKET  )
# 474 "efuns/lisp_mode.ml"

  | 13 ->
# 158 "efuns/lisp_mode.mll"
         ( position lexbuf, LBRACE  )
# 479 "efuns/lisp_mode.ml"

  | 14 ->
# 159 "efuns/lisp_mode.mll"
         ( position lexbuf, RBRACE  )
# 484 "efuns/lisp_mode.ml"

  | 15 ->
# 161 "efuns/lisp_mode.mll"
            ( position lexbuf, IDENT )
# 489 "efuns/lisp_mode.ml"

  | 16 ->
# 162 "efuns/lisp_mode.mll"
        ( let (pos,len) = position lexbuf in (pos,len), EOF pos )
# 494 "efuns/lisp_mode.ml"

  | 17 ->
# 164 "efuns/lisp_mode.mll"
      ( position lexbuf, ERROR )
# 499 "efuns/lisp_mode.ml"
...
and __ocaml_lex_string_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 168 "efuns/lisp_mode.mll"
      ( () )
# 510 "efuns/lisp_mode.ml"

  | 1 ->
# 170 "efuns/lisp_mode.mll"
      ( string lexbuf )
# 515 "efuns/lisp_mode.ml"

  | 2 ->
# 172 "efuns/lisp_mode.mll"
      ( store_string_char(char_for_backslash(Lexing.lexeme_char lexbuf 1));
        string lexbuf )
# 521 "efuns/lisp_mode.ml"

  | 3 ->
# 175 "efuns/lisp_mode.mll"
      ( store_string_char(char_for_decimal_code lexbuf 1);
         string lexbuf )
# 527 "efuns/lisp_mode.ml"

  | 4 ->
# 178 "efuns/lisp_mode.mll"
      ( raise
          (Error (!start_pos + !lexer_start, lexeme_end lexbuf - !start_pos,
                 Unterminated_string)) )
# 534 "efuns/lisp_mode.ml"

  | 5 ->
# 182 "efuns/lisp_mode.mll"
      ( store_string_char(Lexing.lexeme_char lexbuf 0);
        string lexbuf )
# 540 "efuns/lisp_mode.ml"

  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_string_rec lexbuf __ocaml_lex_state

;;

# 185 "efuns/lisp_mode.mll"

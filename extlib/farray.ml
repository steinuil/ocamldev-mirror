...
(* $Id: farray.ml,v 1.2 2001/07/26 16:38:29 lefessan Exp $ *)
...
external array_sblit: float array -> int -> float array -> int -> int -> unit = "array_sblit" "noalloc"
let min_sblit_size = 20

...
(** Max *)
val save_file : Efuns.window -> string -> unit
val file_modified : Efuns.window -> string -> bool
val file_edited : Efuns.window -> string -> bool
val kill_file : Efuns.window -> string -> unit
(** Fin Max *)

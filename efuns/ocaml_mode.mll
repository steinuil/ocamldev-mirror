...
(* for Camlp4 *)
  ...
  let tokens = [AMPERAMPER,"AMPERAMPER"; AMPERSAND,"AMPERSAND";
      ...
      DEF, "DEF"; LOC, "LOC"; BEGINQ, "BEGINQ"; ENDQ, "ENDQ";
      EXTEND, "EXTEND"; VALUE, "VALUE"]
...
rule token = parse
  ...
  | "<:" identchar* "<" { position lexbuf, BEGINQ }
  | ">>" { position lexbuf, ENDQ }
